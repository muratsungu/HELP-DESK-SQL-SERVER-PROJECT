...
CREATE TABLE [ROLE]       --Users roles for system
	(
...
CREATE TABLE COMPANY      --Customer company's infos
	(
	ID INT PRIMARY KEY IDENTITY(1,1),
...
CREATE TABLE PROVINCE     --City infos for address table
	(
	ID INT PRIMARY KEY IDENTITY(1,1),
...
CREATE TABLE DISTRICT     --Distirict infos for address table
	(
	ID INT PRIMARY KEY IDENTITY(1,1),
...
CREATE TABLE COMPANY_ADDRESS_MAPPING  --Addresses
	(	
	ID INT PRIMARY KEY IDENTITY(1,1),
...
CREATE TABLE COMPANY_USER   --Customer users infos
	(
	ID INT PRIMARY KEY IDENTITY(1,1),
...
CREATE TABLE PROFESSION     --Our employees' profession names
	(
	ID INT PRIMARY KEY IDENTITY(1,1),
...
CREATE TABLE DEPARTMENT    --Our employees' department names
	(
	ID INT PRIMARY KEY IDENTITY(1,1),
...
CREATE TABLE EMPLOYEE     --Our employees' infos
	(
	ID INT PRIMARY KEY IDENTITY(1,1),
...
CREATE TABLE ORDER_OF_URGENCY   --Tickets' urgency 
	(
	ID INT PRIMARY KEY IDENTITY(1,1),
...
CREATE TABLE DEMAND_TYPE        --Tickets' types
	(
	ID INT PRIMARY KEY IDENTITY(1,1),
...
CREATE TABLE LICENSE_PERIOD     --Products' license times
	(
	ID INT PRIMARY KEY IDENTITY(1,1),
...
CREATE TABLE PRODUCT            --Products' infos
	(
	ID INT PRIMARY KEY IDENTITY(1,1),
...
CREATE TABLE [VERSION]          --Products' version names
	(
	ID INT PRIMARY KEY IDENTITY(1,1),
...
CREATE TABLE DEMAND_STATE         --Tickets' states
	(
	ID INT PRIMARY KEY IDENTITY(1,1),
...
CREATE TABLE DEMAND				 --Tickets' infos
	(
	ID INT PRIMARY KEY IDENTITY(1,1),
